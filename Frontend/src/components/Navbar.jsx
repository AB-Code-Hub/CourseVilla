          ...
          <div className="hidden md:flex items-center space-x-8">
            {isAuthenticated ? (
              <>
                ...
                <Link
                  to="/admin"
                  className={`px-3 py-2 text-sm font-medium ${location.pathname === '/admin' ? 'text-blue-600' : 'text-slate-700 hover:text-blue-600'}`}
                >
                  Admin Dashboard
                </Link>
        ...
        <div className="px-2 pt-2 pb-3 space-y-1 bg-white shadow-lg">
          {isAuthenticated ? (
            ...
            <Link
                ...
                <Link
                  to="/admin"
                  className={`block px-3 py-2 rounded-md text-base font-medium ${location.pathname === '/admin' ? 'text-blue-600 bg-blue-50' : 'text-slate-700 hover:text-blue-600 hover:bg-slate-100'}`}
                >
                  Admin Dashboard
                </Link>
            </>
